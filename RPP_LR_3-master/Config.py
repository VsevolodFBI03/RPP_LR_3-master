...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:postgres@localhost:5432/LAB_3"
...
class CarTaxParam(db.Model):
    ...
    def __init__(self, id, city_id, from_hp_car, to_hp_car, from_production_year_car,
